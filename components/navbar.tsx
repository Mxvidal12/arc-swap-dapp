...
import { arcAddressUrl } from "@/lib/arcChain"
...
function ArcLogo() {
  return (
    ...
    >
      ...
      <path
        d="M16 6C10.477 6 6 10.477 6 16s4.477 10 10 10"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
...
export function Navbar() {
  const { address, isConnected, isConnecting, isCorrectChain, connectWallet, disconnectWallet } =
    useWeb3()
    ...
    >
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          <div className="ml-2 flex items-center gap-1 border-l border-border/50 pl-4">
            <a
              href={SOCIAL_LINKS.x}
              target="_blank"
              rel="noopener noreferrer"
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                <div className="px-2 py-1.5">
                  ...
                  <p className="text-sm font-medium text-primary">ARC Testnet</p>
                  {!isCorrectChain && (
                    <p className="mt-1 text-xs text-amber-500">
                      Wrong network — use Swap to switch.
                    </p>
                  )}
                </div>
